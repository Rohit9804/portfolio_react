    ...
    <div className="resume" id ="resume">
      ...
      <div className="projects">
        ...
        <div className="project3 pro">
          ...
          <a href="https://github.com/rohit-sama/restaurant-ordering-app" className="github3__" rel="noreferrer" target="_blank">
        ...
        <div className="project4 pro">
          ...
          <a href="https://github.com/rohit-sama/war-game-api" className="github4__" rel="noreferrer" target="_blank">
        ...
        <div className="project5">
          ...
          <a href="https://github.com/rohit-sama/roleplay_game" className="github5__" rel="noreferrer" target="_blank">
